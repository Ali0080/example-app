                  ...
                  <div class="col-md-6">
                     <div class="meta">
                        <h5>
                           ...
                           <span><i class="fa fa-clock-o"></i> 1401/12/12</span>
                           <div class="text-left">
                     ...
                     <a href="#">
                        <figure>
                           ...
                           <figcaption class="txt">
                              ...
                              <span><i class="fa fa-calendar-o"></i> 1401/12/12</span>
         ...
         <div class="col-md-6">
            <div class="content-wrapper">
               <div class="most-views">
                  <span class="title">اخبار داغ</span>
                  <div class="col-md-8">
                     <div class="main-post">
                        <a href="#">
                           <figure>
               ...
               <div class="special-cat-box">
                  <span class="title">اخبار ورزشی</span>
                  <div class="col-md-6">
                     <div class="main-post">
                        <a href="#">
                           <figure>
         ...
         <div class="col-md-3">
            <div class="l-sidebar">
               <div class="cat-sidebar report">
                  <span class="title">اخبار پراکنده</span>
            ...
            <div class="post-box">
               <a href="#">
                  ...
                  <div class="text-p"> 
                     ...
                     <p>{{ $article->lead }}</p>
                     <div class="text-rigt">
                        <a href="{{ route('article.show', $article->id) }}">ادامه ...</a>
                     </div>
                  </div>
               </a>
            </div>
